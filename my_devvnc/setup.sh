...
# DEBIAN_FRONTEND=noninteractive apt-get -y install ubuntu-desktop-minimal task-xfce-desktop task-japanese-desktop fonts-noto-cjk-extra
# DEBIAN_FRONTEND=noninteractive apt-get -y install task-xfce-desktop
